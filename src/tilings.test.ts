...
//
// Note: pentagon-nonconvex uses empirical lattice corrections and does
// not tile the plane exactly (small gaps/overlaps between rosettes are
// expected), so these tests assert per-pentagon topology and geometry
// rather than gap-free closure.
